...
function Copyright(props) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://tubesynchub.tech/">
      Tubesynchub
      </Link>{' '}
...
export default function EditorDashboard() {
  ...
  const handleLogoutClick = () => {
    localStorage.removeItem('auth-token-editor');
    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex' }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <List component="nav">
            <ListItemButton onClick={() => handleListItemClick('invitations')}>
              <ListItemIcon>
                <InsertInvitationIcon />
              </ListItemIcon>
              <ListItemText primary="Invitations" />
            </ListItemButton>
            <ListItemButton onClick={() => handleListItemClick('submitvideo')}>
              <ListItemIcon>
                <VideoCallIcon />
              </ListItemIcon>
              <ListItemText primary="SubmitVideo" />
            </ListItemButton>
            <ListItemButton onClick={() => handleListItemClick('allsubmissions')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Allsubmissions" />
            </ListItemButton>
          </List>
        </Drawer>
        <Box
            ...
            <Grid item xs={12} md={8} lg={9}>
              <div
                style={{
                  ...
                  height: '100%', // Make sure the parent container takes up the full height
                }}
              >
                <Paper
                  sx={{
